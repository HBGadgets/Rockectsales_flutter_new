...
class Filtrationsystemorder extends StatefulWidget {
  const Filtrationsystemorder({super.key});

  @override
  State<Filtrationsystemorder> createState() => _FiltrationsystemorderState();
}

class _FiltrationsystemorderState extends State<Filtrationsystemorder> {
  DateTime? fromDate;
  DateTime? tillDate;
