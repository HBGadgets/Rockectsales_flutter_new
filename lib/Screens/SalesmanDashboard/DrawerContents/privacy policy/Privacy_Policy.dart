...
class PrivacyPolicy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Privacy Policy"), foregroundColor: Colors.white, backgroundColor: MyColor.dashbord, leading: BackButton(onPressed: () => Navigator.pop(context),),),
