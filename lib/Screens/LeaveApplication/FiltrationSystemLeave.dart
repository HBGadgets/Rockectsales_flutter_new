...
import 'package:rocketsales/Screens/LeaveApplication/LeavesController.dart';

import '../../resources/my_colors.dart';

class Filtrationsystemleave extends StatefulWidget {
  const Filtrationsystemleave({super.key});

  @override
  State<Filtrationsystemleave> createState() => _FiltrationsystemleaveState();
}

class _FiltrationsystemleaveState extends State<Filtrationsystemleave> {
  DateTime? fromDate;
  DateTime? tillDate;
